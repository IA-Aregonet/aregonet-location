...
require_once(ROOT_DIR . "/helpers/utils.php");
  ...
  */
  class uDb extends PDO {
     ...
     */
    private static $dbdsn = "mysql:host=localhost;port=3307;dbname=aregonet_gps;charset=utf8";
    /**
     * @var string Database user
     */
    private static $dbuser = "aregonet_gps";
    /**
     * @var string Database pass
     */
    private static $dbpass = "021D*n13l_";
    /**
